// src/components/Checkout/AddressSelector.js
      ...
      {selectedAddress && (
        <div className="address-details mb-3">
          ...
          <Form.Group className="mb-3">
            <Form.Control type="text" value={selectedAddress.label} readOnly />
          </Form.Group>
          <Row>
            <Col md={6}>
              <Form.Group className="mb-3">
                <Form.Control type="text" value={selectedAddress.aptNo || 'N/A'} readOnly />
              </Form.Group>
            </Col>
            <Col md={6}>
              <Form.Group className="mb-3">
                <Form.Control type="text" value={selectedAddress.floor || 'N/A'} readOnly />
              </Form.Group>
            </Col>
          </Row>
          <Form.Group className="mb-3">
            <Form.Control type="text" value={selectedAddress.street} readOnly />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Control
              as="textarea"
              rows={3}
              value={selectedAddress.description || 'No additional details'}
              readOnly
            />
          </Form.Group>
        </div>
                  ...
                  <Card.Body>
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        ...
                        <p>
                          {address.street}, {address.aptNo ? `Apt ${address.aptNo}, ` : ''}
